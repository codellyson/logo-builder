...
function recolor(n: CanvasNode, target: string): CanvasNode {
  ...
  if (n.type === 'rect') return { ...n, fill: f, stroke: n.stroke ? f : null }
  if (n.type === 'ellipse') return { ...n, fill: f, stroke: n.stroke ? f : null }
  if (n.type === 'line') return { ...n, stroke: f }
  if (n.type === 'text') return { ...n, fill: f }
  if (n.type === 'icon') return { ...n, fill: f }
  if (n.type === 'path') return { ...n, fill: n.fill ? f : null, stroke: n.stroke ? f : null }
  return n
}
